import type { ImportSummary, PreviewOutcome } from '../domain/import-batch.ts';
...
/** 預覽分類（需求規格 11.1）；匯入頁的預覽與總覽的年度工作摘要共用。 */
...
export function importSummaryText(summary: ImportSummary): string {
  return (Object.keys(OUTCOME_LABELS) as PreviewOutcome[])
